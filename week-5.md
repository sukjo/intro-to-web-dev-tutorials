...
[... design principles re: composition, rule of thirds]
[... information architecture]
[... suggested tools: excalidraw, figma, sketch, literal paper, even google slides]
...
The flex container and flex items can have different flex properties. Here they are at a glance:
...
- altogether, the default values would be `0 1 auto`
...
Lastly, this [CSS Tricks Flexbox Layout Guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/) is an especially handy resource for flexbox users at any stage of familiarity. I myself relied on it quite a bit while writing this section of the tutorial. Use it to your advantage!

## Grids, briefly

[... example: https://www.centreforthestudyof.net/]

## Positioning

Using the `position` property, you can determine an element's location relative to its original flow or irrelevant to it. This property is usually paired with `top`, `bottom`, `left`, and/or `right` properties, which are used to decide the vertical and horizontal position of an element on the page.
...
[... user agent stylesheets -- the notion; getting more streamlined?]
[... image DevTools -> same webpage rendered as diff browsers]
